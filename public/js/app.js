...
var add_pizza = document.querySelectorAll('.add_pizza');
var remove_pizza = document.querySelectorAll('.remove_pizza');
var pizza_update = document.querySelectorAll('.pizza_update');
var cart_total_qty = document.querySelector('.cart_total_qty');
var cart_total_price = document.querySelector('.cart_total_price');
var cart_itom = document.querySelectorAll('.cart_itom');
var pizz_prize = document.querySelectorAll('.pizz_prize');
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              _context.next = 3;
              return axios.post('/update', JSON.parse(btn.dataset.btnitom));
...
add_pizza.forEach(function (btn, index, arr) {
  btn.addEventListener('click', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              e.preventDefault();
              _context2.next = 3;
              return axios.post('/additom', JSON.parse(btn.dataset.pizza));

            case 3:
              data = _context2.sent;
              pizza_update[index].innerText = Number(pizza_update[index].innerText) + 1;
              cart_add.innerText = data.data.cart.totalqty;
              cart_total_price.innerText = data.data.cart.totalPrice; //     console.log(pizz_prize[index].innerText)
              // console.log(JSON.parse(btn.dataset.pizza).itom.price)

              pizz_prize[index].innerText = Number(pizz_prize[index].innerText) + Number(JSON.parse(btn.dataset.pizza).itom.price); // cart_itom[index].style.display = "none";
...
remove_pizza.forEach(function (btn, index, arr) {
  btn.addEventListener('click', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              e.preventDefault();
              _context3.next = 3;
              return axios.post('/removeitom', JSON.parse(btn.dataset.pizza));
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkpizza_realtime"] = self["webpackChunkpizza_realtime"] || [];
